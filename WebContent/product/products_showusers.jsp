<%@ page language="java"
	import="java.util.*,com.ascent.bean.Productuser" pageEncoding="UTF-8"%>
<%
									...
									<td width="9%">
										<div align="center">
											<a href="user?a=finduser&uid=<%=pu.getUid()%>"><img
												src="<%=path%>/images/update1.gif" width="20" height="20"
												border="0" alt="修改" /> </a>
										</div>
									</td>
									<td width="10%">
										<div align="center">
											<a
												...
												src="<%=path%>/images/Changeuser.gif" width="20" height="20"
												border="0" alt="角色修改" /> </a>
										</div>
									</td>
									<%
									...
									<td>
										<div align="center">
											<a href="user?a=delsuser&uid=<%=pu.getUid()%>&value=0"
												...
												src="<%=path%>/images/sz_tu01.gif" border="0" alt="删除" /> </a>
										</div>
									</td>
									<%
										} else {
									...
									<td>
										<div align="center">
											<a href="user?a=delsuser&uid=<%=pu.getUid()%>&value=1"
												onclick="return confirm_oper();"><img
												src="<%=path%>/images/sz_tu02.gif" border="0" alt="恢复" /> </a>
										</div>
									</td>
									<%
										}
