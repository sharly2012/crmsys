										...
										<tbody>
											<tr>
												...
												<td>
													<div align="left">
														|&nbsp;&nbsp;欢迎,<%=p.getUsername()%>&nbsp;&nbsp;|&nbsp;&nbsp;
														<a href="<%=request.getContextPath()%>/login?a=out"
															class="table_t">注销</a>&nbsp;&nbsp;|
													</div>
												</td>
												<td>
												...
												<td>
													<div align="left">
														|&nbsp;&nbsp;欢迎,<%=p.getUsername()%>&nbsp;&nbsp;|&nbsp;&nbsp;
														<a href="<%=request.getContextPath()%>/logina=out"
															class="table_t">注销</a>&nbsp;&nbsp;|
													</div>
												</td>
												<td>
												...
												<td>
													<div align="center">
														<a
															href="<%=request.getContextPath()%>/product/checkout.jsp">结算中心</a>
													</div>
												</td>
												<%
										...
										<tbody>
											...
											<tr>
												...
												<td bgcolor="#f3f3f3">
													<div align="center">
														<a
															href="<%=request.getContextPath()%>/order?a=finditem&oid=<%=orderid%>">查看</a>
													</div>
												</td>
											</tr>
											<%
