...
<body>
	<form name="form" method="post"
		action="<%=request.getContextPath()%>/user?a=regis" />
	<div id="container">
		<div id="header"></div>
		<div id="navigation">
			<ul>
											...
											<table width="70%" class="mars" cellspacing="1"
												...
												<tbody>
													...
													<tr>
														...
														<td width="7%"></td>
														<td><input type="text" name="code" id="code">&nbsp;&nbsp;<font
															color="red">*</font>

															<div id="codeCheckDiv" class="warning">
																<img src="authImg" id="authImg" /><a
																	href="product/register.jsp#" onClick="refresh()">换一张</a>
															</div></td>
													...
													<tr>
														<td colspan="2" align="center"><input type="submit"
															value="注册" onClick="return check();" /> <input
