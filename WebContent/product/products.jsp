<%@ page language="java" import="com.ascent.bean.Productuser"
...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/js/acesys.js"></script>
</head>
...
<body>
	<div id="container">
		...
		<div id="content">
			...
			<div class="md_wenzi">
				...
				中间体服麻醉剂进入合理的价格和优良品质。 请参观<a
					href="<%=request.getContextPath()%>/product?a=all">浏览产品页</a>。<br />
				编目可以在网上被观看或者由<a
					href="<%=request.getContextPath()%>/product/Product_Search.jsp">查询产品浏览产品</a>
		...
		<div id="subcontent">
			<form name="form" method="post"
				...
				<div class="small box">
					...
					<table width="150" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="30%" colspan="2" valign="middle"><img
								src="<%=request.getContextPath()%>/images/username.jpg"
								width="61" height="17" align="bottom" /> <input name="username"
								type="text" size="7" /></td>
						</tr>
						<tr>
							<td colspan="2" valign="middle"><img
								src="<%=request.getContextPath()%>/images/password.jpg"
								width="61" height="17" /> <input name="password"
								type="password" size="6" /></td>
						</tr>
						<tr>
							<td height="30" valign="bottom">点击这里<a
								href="<%=request.getContextPath()%>/product/register.jsp">注册</a></td>
							<td align="left" valign="bottom"><a href="#"> <input
									name="image" type="image" onclick="return checkLogin(form);"
									src="<%=request.getContextPath()%>/images/login_1_7.jpg"
			...
			<h2>最新商品列表</h2>
			<ul class="menublock">
				<li><a href="#">项目实战精解</a><a href="#"><img
						src="<%=request.getContextPath()%>/images/buy.gif" width="20"
						height="16" border="0" /></a></li>
				<li><a href="#">java核心技术</a><a href="#"><img
						src="<%=request.getContextPath()%>/images/buy.gif" width="20"
						height="16" border="0" /></a></li>
			</ul>
		</div>
