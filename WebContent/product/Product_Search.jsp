...
<body>
	<form name="form" method="post"
		action="<%=request.getContextPath()%>/product?a=search">
		<div id="container">
			<div id="header"></div>
			<div id="navigation">
				<ul>
						...
						<td height="15" align="left" valign="top" class="12">
							...
							<div class="table_wz">
								...
								<table width="680" height="100" border="0" cellpadding="0"
									...
									<tbody>
										<tr>
											<td width="184" height="20" class="table_hui"><div
													align="right"></td>
											<td width="204"></td>
										</tr>
										<tr>
										...
										<tr>
											<td height="30" class="table_hui"></td>
											<td height="30" class="table_hui"><input type="submit"
												name="Submit" value="查询" onclick="return check();" /></td>
											<td height="30" class="table_hui"><input type="reset"
