						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="30%"><div align="left">
										|&nbsp;&nbsp;欢迎,<%=p.getUsername()%>&nbsp;&nbsp;|&nbsp;&nbsp;<a
											href="<%=request.getContextPath()%>/login?a=3"
								...
								<td width="15%"><div align="center">
										<a
											href="<%=request.getContextPath()%>/product/Product_Search.jsp">商品查询</a>
									</div></td>
								<td width="20%"><div align="center">
										<a href="<%=request.getContextPath()%>/shopcart?a=find">查看购物车</a>
									</div></td>
						...
						<table width="100%" border="1" cellspacing="0" cellpadding="0"
							...
							<tr bgcolor="#f3f3f3" height="25">
								...
								<td width="12%"><div align="center">
										<img
											src="<%=request.getContextPath() + "/upload/" + pu.getStructure()%>"
