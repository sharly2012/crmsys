...
<body>
	<form name="form" method="post"
		action="<%=request.getContextPath()%>/product?a=save"
 ...
 %>
						<table width="100%">
							<tbody>
								<tr>
									...
									<td>
										<div>
											<a href="<%=path%>/user?a=all"><img
												src="<%=path%>/images/userlist.jpg" border="0" /></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<a href="<%=path%>/product?a=all"><img
												src="<%=path%>/images/productslist.jpg" border="0" /></a>&nbsp;&nbsp;&nbsp;&nbsp;
											<a href="<%=path%>/order?a=all"><img
												src="<%=path%>/images/ShowOrders.jpg" border="0" /></a>
											&nbsp;&nbsp;&nbsp;&nbsp; <a
												href="<%=path%>/product/add_products_admin.jsp"><img
												src="<%=path%>/images/addProduct.jpg" border="0" /></a>&nbsp;&nbsp;&nbsp;&nbsp;
										</div>
									</td>
								</tr>
								<!-- 产品列表 -->
						...
						<table width="680" border="0" cellpadding="0" cellspacing="0">
							<tbody>
								...
								<tr>
									<td width="110" height="20" class="table_c">商品信息</td>
						...
						<table width="500" border="0" cellspacing="0"
							...
							<tr>
								...
								<td width="163" height="15"><input name="productname"
									type="text" /></td>
							</tr>
							<tr>
								<td width="122" height="15" class="table_c"><div
							...
							<tr>
								...
								<td height="15" class="table_c">是: <input type="radio"
									name="newproduct" value="1" /> 否: <input type="radio"
									name="newproduct" value="0" checked />
								</td>
							</tr>
							<tr>
								<td width="122" height="15" class="table_c"><div
										align="right">Formula:</div></td>
								<td width="122"><input name="formula" type="text" /></td>
							...
							<tr>
								<td width="122" height="15" class="table_c"><div
										align="right">价格1:</div></td>
								<td width="122"><input name="price1" type="text" /></td>
							...
							<tr>
								<td height="15" colspan="4"><div align="center">
										...
										<div class="loading_ll">
											...
											<!--  input type="submit"  src="<%=request.getContextPath()%>\images\Add.jpg" onclick="return addproducts();"  border="0"/-->
										</div>
									</div></td>
							</tr>
						</table>
